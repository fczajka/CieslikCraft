  ...
  class Dismiss extends React.Component {
    ...
    <nav className="sidebar">
      ...
      <ul className="sidebar-list-links">
        <li className="sidebar-links"><Link to="/"><p className="link">HOME</p></Link></li>
        ...
        <li className="media-links"><a href="http://www.sea-line.eu/pl/disco-volante/?fbclid=IwAR2weFH-8gXCd5Ik8kkD3RbxHqMujbeta-BI8s_BnieuAQiL8FaHil5s3wE" target="_blank">Sea-line</a></li>
        <li className="media-links"><a href="http://www.jachtowe.com.pl/disco-volante.html?fbclid=IwAR1SLLIGAkAXK-2OV_o-qG8Z519A6UTPNdR9dg390Sr1H3PCVIPpCMFxT60" target="_blank">Jachtowe.com.pl</a></li>
      </ul>
